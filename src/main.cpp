...
int64 nChainStartTime = 1405354381;
...
const string strMessageMagic = "dulorcoin Signed Message:\n";
...
int64 GetProofOfWorkReward(int nHeight, int64 nFees, uint256 prevHash)
{
    ...
    if(nHeight == 1)
        nSubsidy = 200000 * COIN; // 4% for the stripper fund
    else if(nHeight > 1 && nHeight <= 100)
	nSubsidy = 1 * COIN; 
    else if(nHeight > 100 && nHeight <= 20100)
	nSubsidy = 250 * COIN;
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in dulorcoin
    bool fStrictPayToScriptHash = true; // Always active in dulorcoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "dulorcoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "I am very super famous, super famous, super famous BITCH! I am very super famous, a lot of people know i exits";
        CTransaction txNew;
        ...
        assert(block.hashMerkleRoot == uint256("0xddeb885f3c9d46e3a69e0cee7522398ac036f51daba047491993fb0a75c7a1f8"));
